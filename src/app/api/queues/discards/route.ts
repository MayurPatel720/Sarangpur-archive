...
/** GET /api/queues/discards — discarded lots, oldest first, `discards:view`. */
export async function GET(req: Request) {
  ...
  return handleQuery(
    ...
    () => runQueue('discards', parsed.data.page, parsed.data.pageSize),
    { permission: queuePermission('discards') },
  );
}
