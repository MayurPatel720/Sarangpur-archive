...
/** GET /api/queues/returns — return.status ∈ pending/in_progress, oldest first, `returns:view`. */
export async function GET(req: Request) {
  ...
  return handleQuery(
    ...
    () => runQueue('returns', parsed.data.page, parsed.data.pageSize),
    { permission: queuePermission('returns') },
  );
}
